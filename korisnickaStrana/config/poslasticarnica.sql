...
INSERT INTO `vesti` (`id`, `naziv`, `opis`, `slika`) VALUES
	...
	(9, 'Prolećna kolekcija: Voćni dezerti stigli!','Prolećni ukusi su stigli! Uživajte u novim voćnim kolačima sa malinom, borovnicom i limunom – lagani deserti za svaki dan.', 'korisnickaStrana/public/slike/BlueAndLemon.jpg'),
	(10, 'Novi program: Torte bez glutena', 'Uvodimo torte bez glutena pripremljene od pažljivo biranih sastojaka, idealne za goste koji prate poseban režim ishrane.', 'korisnickaStrana/public/slike/GlutenFree.jpg'),
	(11, 'Vikend popusti na mini kolače!', 'Samo ovog vikenda mini kolači i sitne poslastice su na specijalnom popustu od 20%. Savršena prilika da isprobate više različitih ukusa.', 'korisnickaStrana/public/slike/SmallDesert.jpg'),
	(12, 'Nova kolekcija čokoladnih pralina', 'Predstavljamo ručno rađene čokoladne praline od vrhunske čokolade punjene lešnikom, karamelom i voćnim kremovima.', 'korisnickaStrana/public/slike/ChocoPralines.jpg'),
