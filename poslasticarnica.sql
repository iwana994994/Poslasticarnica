...
(20, 'Poštovani, da li ćete uskoro ponovo imati tiramisu na akciji? Prošli put sam propustio i voleo bih da poručim nekoliko komada.', 'Strahinja', 'strahinjast15@yahoo.com', '2025-11-23 13:05:17'),
(21, 'Da li pravite torte po narudžbini? Trebala bi mi čokoladna torta za rođendan sledeće nedelje.', 'Jovana', 'jovana15@gmail.com', '2025-11-23 13:05:36'),
(22, 'Samo želim da pohvalim vaše kolače — svaki put svežiji i ukusniji! Posebno mi se dopao cheesecake.', 'Milica', 'milicajovic@hotmail.com', '2025-11-23 13:05:53'),
(23, 'Interesuje me da li imate dostavu i koje je minimalno vreme unapred potrebno da se poruči?', 'Dejan', 'dex16@yahoo.com', '2025-11-23 13:06:11');
...
(17, 'Prolećna kolekcija: Voćni dezerti stigli!', 'Prolećni ukusi su stigli! Uživajte u novim voćnim kolačima sa malinom, borovnicom i limunom – lagani deserti za svaki dan.', 'korisnickaStrana/public/slike/BlueAndLemon.jpg'),
(18, 'Novi program: Torte bez glutena', 'Uvodimo torte bez glutena pripremljene od pažljivo biranih sastojaka, idealne za goste koji prate poseban režim ishrane.', 'korisnickaStrana/public/slike/GlutenFree.jpg'),
(19, 'Vikend popusti na mini kolače!', 'Samo ovog vikenda mini kolači i sitne poslastice su na specijalnom popustu od 20%. Savršena prilika da isprobate više različitih ukusa.', 'korisnickaStrana/public/slike/SmallDesert.jpg'),
(20, 'Nova kolekcija čokoladnih pralina', 'Predstavljamo ručno rađene čokoladne praline od vrhunske čokolade punjene lešnikom, karamelom i voćnim kremovima.', 'korisnickaStrana/public/slike/ChocoPralines.jpg'),
